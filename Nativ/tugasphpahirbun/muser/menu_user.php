...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            <li class="active"><a href="menu_user.php">Data Service</a></li>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="update_service.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil"></i></a>
                                        &nbsp;
                                        <a class="btn btn-danger" href="delete_service.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash"></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                        <tfoot>   
