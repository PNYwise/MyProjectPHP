	...
	<nav class="navbar fixed-top navbar-expand-lg">
		  ...
		  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item">
		        <a class="nav-link" href="#" style="margin-top: 15px">Service</a>
		      </li>
		      <li class="nav-item">
	...
	<div class="container">
		<div class="row">
			<div class="col" align="center">
				<h1 style ="margin-bottom: 5rem">Service</h1>
			</div>
		</div>
		<div class="row">
			<?php
            ...
            ?>
			<div class="col" align="center" style="margin-bottom: 3rem">
				<div class="card" style="width: 18rem;" height="199px;">
				  <img src="<?php echo 'foto/'.$row['foto']; ?>" class="card-img-top" alt="..." width="300px" height="300px">
				  <div class="card-body">
