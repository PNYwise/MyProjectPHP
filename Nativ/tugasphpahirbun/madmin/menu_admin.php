...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            <li class="active"><a href="#">Setting User</a></li>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="update_user.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil"></i></a>
                                &nbsp;
                            <a class="btn btn-danger" href="delete_user.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash"></i></a></td>
                        </tr>
                    <?php } ?>
                  </tbody>
                  <tfoot>   
